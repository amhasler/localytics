...
var changeArrow, getPercentChange, industry, makeBenchmarkPretty, makePrettyBig, makePrettyPercent, placeBench, placePretty, prettyPlaceTimes, setIndustry, updateUS;
...
prettyPlaceTimes = function(times) {
  ...
  times = (function() {
    ...
    for (_i = 0, _len = times.length; _i < _len; _i++) {
      time = times[_i];
      _results.push((numeral(time / 60).format('0,0.0')) + " minutes");
    }
    return _results;
  })();
